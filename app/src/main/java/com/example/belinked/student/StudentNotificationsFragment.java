...
public class StudentNotificationsFragment extends Fragment {
    ...
    public static StudentNotificationsFragment newInstance(String param1, String param2) {
        StudentNotificationsFragment fragment = new StudentNotificationsFragment();
